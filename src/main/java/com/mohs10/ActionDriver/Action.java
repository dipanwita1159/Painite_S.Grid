...
//	}
	...
	public void encryptData( By Locator,String excelFilePath,String excelsheet) throws IOException {
...
public static  void getDecryptedPassword( By Locator,String excelFilePath,String excelsheet,  int dataColumnIndex, int rowIndex) throws IOException {
    // Construct the path to the input Excel file
    File inputFile = new File(excelFilePath);
    ...
    Cell encryptedPasswordCell = row.getCell(dataColumnIndex);
